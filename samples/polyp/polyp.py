...
class PolypConfig(Config):
    ...
    NUM_CLASSES = 1 + 1  # Background + polyp
...
def train(model):
    ...
    dataset_train.load_polyp(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = PolypDataset()
    dataset_val.load_polyp(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect polyps.')
    parser.add_argument("command",
                        metavar="<command>",
                        help="'train' or 'splash'")
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/polyp/dataset/",
                        help='Directory of the Polyp dataset')
    ...
    if args.command == "train":
        ...
        class InferenceConfig(PolypConfig):
